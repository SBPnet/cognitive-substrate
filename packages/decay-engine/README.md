...
`@cognitive-substrate/decay-engine` is a top-level package used by the Cognitive Substrate workspace. Its public API is the package export surface, not this README.

## Entrypoints

- Source: `packages/decay-engine/src/index.ts`
- Package main: `./dist/index.js`
- Package metadata: `packages/decay-engine/package.json`
