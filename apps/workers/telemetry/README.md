...
`@cognitive-substrate/telemetry-worker` is a worker application. Its source lives in `apps/workers/telemetry/src/` and should be evaluated by the Kafka topics, storage clients, and environment flags it actually imports.

## Entrypoints

- Source: `apps/workers/telemetry/src/main.ts`
- Package main: `./dist/main.js`
- Package metadata: `apps/workers/telemetry/package.json`
